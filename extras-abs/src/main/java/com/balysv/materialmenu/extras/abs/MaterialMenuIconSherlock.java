...
public class MaterialMenuIconSherlock extends MaterialMenuBase {
    ...
    public MaterialMenuIconSherlock(SherlockActivity activity, int color) {
        this(activity, color, DEFAULT_TRANSFORM_DURATION, DEFAULT_PRESSED_DURATION);
    }

    public MaterialMenuIconSherlock(SherlockActivity activity, int color, int transformDuration) {
        this(activity, color, transformDuration, DEFAULT_PRESSED_DURATION);
    }

    public MaterialMenuIconSherlock(SherlockActivity activity, int color, int transformDuration, int pressedDuration) {
